...
Function DisableStrongNameVerification([Parameter(Mandatory = $True)][string] $publicKeyToken)
{
    $regKey = "HKLM:SOFTWARE\Microsoft\StrongName\Verification\*,$publicKeyToken"
    $regKey32 = "HKLM:SOFTWARE\Wow6432Node\Microsoft\StrongName\Verification\*,$publicKeyToken"
...
DisableStrongNameVerification 'b03f5f7f11d50a3a' # Microsoft
DisableStrongNameVerification '31bf3856ad364e35' # NuGet
DisableStrongNameVerification 'af2d2ab0170a966c' # <RepoRoot>\test\TestExtensions\GenerateTestPackages\ToolTestKey.snk
